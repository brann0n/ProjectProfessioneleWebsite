            ...
            <div class="mainBody">
                ...
                <div class="mainContent">
                    <div class='galleryContent'>
                        <h2>Gallerij</h2>
                        <p>Op deze pagina kunt u beeldmateriaal van onze school vinden.</p>
                    ...
                    <div class='uploadImageSection'>
                        ...
                        if (isset($_SESSION["authenticated"])) {
                            if ($_SESSION["authenticated"]) {
                                ...
                                echo 'Je moet ingelogd zijn om afbeeldingen te kunnen uploaden <a id="signinBtn" href="login.php">Inloggen</a>';
                            }
                        } else {
